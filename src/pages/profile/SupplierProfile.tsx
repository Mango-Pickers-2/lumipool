...
export default function SupplierProfile() {
  ...
  return (
    <div className="min-h-screen bg-muted/20">
      ...
      <main className="mx-auto max-w-[1150px] px-8 py-10">
        {/* Header */}
...
function LogoutButton({
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-between rounded-xl border border-destructive/20 bg-destructive/5 hover:bg-destructive/10 px-5 py-4 transition"
    >
      <div className="flex items-center gap-3">
